...
<script>
    ...
    <div class="container">
        ...
        <table style="margin-left: auto; margin-right: auto;">
          <tr> 
              <td><input class="inputText" type="text" id="naam" name="naam" placeholder="Naam" tabindex="-1" readonly="readonly"></td>
              <td></td>
          </tr>
          <tr>
              <td><input class="inputText" type="text" name="studentenNummer" placeholder="Studentennummer" tabindex="-1" readonly="readonly"></td>
              <td></td>
          </tr>
          <tr>
              <td><input class="inputText" type="text" name="schoolMail" placeholder="Schoolmail" tabindex="-1" readonly="readonly"></td>
              <td></td>
          </tr>
          <tr>
              <td>
              ...
              <td>
                  <button id="pencilButton" onclick="document.getElementById('wachtwoord').readOnly = false; document.getElementById('wachtwoord').focus(); addBody();" id="pencilButton">
