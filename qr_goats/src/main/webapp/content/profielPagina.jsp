...
<body>
    ...
    <div class="container">
        ...
        <div class="aangepasteDif">
	        ...
	        <form action="" method="">
	          <tr> 
	              <td><input class="inputText" type="text" id="naam" name="naam" placeholder="${Student.naam} ${Student.tussenvoegsel} ${Student.achternaam}" tabindex="-1" readonly="true"/></td>
	              <td></td>
	          </tr>
	          <tr>
	              <td><input class="inputText" type="number" name="studentenNummer" placeholder="${Student.studentenNR}" tabindex="-1" readonly="true"/></td>
	              <td></td>
	          </tr>
	          <tr>
	              <td><input class="inputText" type="email" name="schoolMail" placeholder="${Account.email}" tabindex="-1" readonly="true"/></td>
	              <td></td>
	          </tr>
	          </form>
	          <s:form method="post" action="WijzigWachtwoordCheck" enctype="multipart/form-data">
	          <tr>
	              <td>
