...
<body>
	...
	<div class="container">
		<s:form class="terugbutton" action="Home" method="POST">
			<input class="terug" type="submit" value="<"></input>
		</s:form>
		<h1 class="titel">Profiel</h1>
		<img id="pfp" class="profielFoto"
		...
		<div class="aangepasteDif">
			<table class="table_groote">
				...
				<tr>
					<td><label class="profielLabel">Naam</label><input
						class="inputText" type="text" id="naam" name="naam"
						placeholder="${Student.naam} ${Student.tussenvoegsel} ${Student.achternaam}"
						tabindex="-1" readonly="true" /></td>
					<td></td>
				</tr>
				<tr>
					<td><label class="profielLabel">Studenten-Nummer</label><input
						class="inputText" type="number" name="studentenNummer"
						placeholder="${Student.studentenNR}" tabindex="-1" readonly="true" /></td>
					<td></td>
				</tr>
				<tr>
					<td><label class="profielLabel">E-mail</label><input
						class="inputText" type="email" name="schoolMail"
						placeholder="${Account.email}" tabindex="-1" readonly="true" /></td>
					<td></td>
				</tr>
